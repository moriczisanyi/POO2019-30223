...
abstract public class Animal implements Killer,XML_Parsable{
	...
	public void decodeFromXml( javax.lang.model.element.Element element2) {
		setNrOfLegs (Integer.valueOf(((Element) element2).getElementsByTagName("nrOfLegs").item(0).getTextContent()));
		setName(((Element) element2).getElementsByTagName("name").item(0).getTextContent()) ;
		setMaintenanceCost (Double.valueOf(((Element) element2).getElementsByTagName( "maintenanceCost").item(0).getTextContent()));
