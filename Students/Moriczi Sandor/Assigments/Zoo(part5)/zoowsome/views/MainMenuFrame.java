...
// adding empty panel to fill grid layout
		...
		pan.add(btnAdd);
		btnToBeListed = new JButton("ToBeListed");
		slPanel.putConstraint(SpringLayout.NORTH, btnToBeListed, 150, SpringLayout.NORTH, pan);
		slPanel.putConstraint(SpringLayout.WEST, btnToBeListed, 94, SpringLayout.WEST, pan);
		pan.add(btnToBeListed);
	...
	public void setToBeListedButtonActionListener(ActionListener a) {
		btnToBeListed.addActionListener(a);
	}
